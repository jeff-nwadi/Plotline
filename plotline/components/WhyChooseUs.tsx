    ...
    return (
        <div ref={container} className="py-32 px-6 md:px-10 lg:px-36 bg-black text-white relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 pt-10">
                ...
                <div className="why-card-wrapper opacity-0">
                    <div className="why-card group p-8 -rotate-6 rounded-[32px] bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all duration-500 hover:-translate-y-8 hover:rotate-0 hover:z-20 md:-rotate-12 transform-gpu">
                ...
                <div className="why-card-wrapper opacity-0">
                    <div className="why-card group p-8 rotate-0 rounded-[32px] bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all duration-500 hover:-translate-y-8 hover:rotate-0 hover:z-20 md:rotate-0 md:-translate-y-8 transform-gpu">
                        <div className="mb-6 w-14 h-14 rounded-2xl bg-[#355E3B]/20 flex items-center justify-center text-[#4a7a58] group-hover:bg-[#355E3B] group-hover:text-white transition-colors duration-300">
                            <Sparkles size={32} />
                        </div>
